...
namespace Test_Chamber
{
    ...
    public class BitCounterTest
    {
        ...
        public void Execute_RunOnce_ObsCountIsHalfTheRecievedBitsAfterExecute()
        {
            ...
            bool result = CPH._sources.TryGetValue(SOURCES.BIT_COUNT.Source, out Source<string> afterValue);
        ...
        public void Execute_RunOnce_ObsCountCountCorrectBeforeExecute()
        {
            ...
            bool result = CPH._sources.TryGetValue(SOURCES.BIT_COUNT.Source, out Source<string> beforeValue);
